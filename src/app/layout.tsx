            ...
            <div className="flex">
              ...
              <div className="w-3/5 border border-gray-600 h-auto  border-t-0">
                <div className="flex">
                      ...
                      <div className="flex-1 px-4 py-2 m-2">
                          <a href="" className=" text-2xl font-medium rounded-full text-white hover:bg-gray-800 hover:text-gray-300 float-right" target="_blank">
              ...
              <div className="w-2/5 h-12">
                ...
                <div className="relative text-gray-300 w-80 p-5 pb-0 mr-16">
                    ...
                    <input type="search" name="search" placeholder="Search Threads" className="bg-gray-800 h-10 px-10 pr-5 w-full rounded-full text-sm focus:outline-none bg-purple-white shadow rounded border-0" />
                </div>
